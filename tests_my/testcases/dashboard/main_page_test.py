...
from tests_my.pages.dashboard.design_page import DesignPage
...
class Test_MainPage(TestBase):
    ...
    def test_main_page_tc_021(self, setup_class):
        ...
        self.design_page._add_page(self.page1, self.parent_page)

        logging.info("Add page2")
        self.design_page._add_page(self.page2, self.page1)

        logging.info("Select page1")
        self.dashboard_page.select_page(self.parent_page, self.page1)

        logging.info("Edit page1 to page3")
        self.design_page._edit_page(self.page3)
        ...
        self.design_page._edit_page(self.page4)
